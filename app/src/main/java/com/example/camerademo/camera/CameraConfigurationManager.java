...
final class CameraConfigurationManager {
    ...
    public void setPreviewMax(int max) {
        previewMax = max;
    }
    ...
    void initFromCameraParameters(Camera camera, SurfaceHolder holder) {
        ...
        cameraResolution = findBestPictureSizeValue(parameters.getSupportedPreviewSizes(), screenResolution);
        cameraPictureSize = findBestPictureSizeValue(parameters.getSupportedPictureSizes(), screenResolution);
...
//        Camera.Size size = imageSizes.get(0);
//        return new Point(size.width, size.height);
        return new Point(1111, 222);
//        int bestX = 0;
//        int bestY = 0;
//        int maxX = 0;
//        int maxY = 0;
